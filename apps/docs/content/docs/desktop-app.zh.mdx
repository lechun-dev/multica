...
把输出的哈希和[最新 release](https://github.com/lechun-dev/multica/releases/latest) 里 `checksums.txt` 对应那一行比对。
...
<Callout type="warning">
只有在你是从[下载页](https://multica.ai/download)或 [GitHub releases](https://github.com/lechun-dev/multica/releases) 安装、且校验和对得上的前提下，才加这些排除项。排除项会关闭该文件夹内所有文件的实时保护。
</Callout>
