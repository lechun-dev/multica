...
DingTalk、WeCom、Telegram は[コミュニティメンテナンス](/community-maintained)です。各リリースに含まれますが、公式サポート SLA はありません。問題は [GitHub issues](https://github.com/lechun-dev/multica/issues) で報告してください。
