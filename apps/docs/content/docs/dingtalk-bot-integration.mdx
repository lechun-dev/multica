...
<Callout type="info">
The DingTalk integration is [community-maintained](/community-maintained) and has no official support SLA. Report problems in [GitHub issues](https://github.com/lechun-dev/multica/issues).
</Callout>
