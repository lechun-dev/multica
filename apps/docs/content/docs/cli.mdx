...
[Multica CLI skill](https://github.com/lechun-dev/multica-cli) teaches those agents
...
- [Multica CLI skill](https://github.com/lechun-dev/multica-cli) — operate Multica from Codex, Claude Code, or Cursor.
