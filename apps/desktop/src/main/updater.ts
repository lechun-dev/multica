...
/**
 * 2026-09-10 coder(lq): Select the feed from the packaged identity so stable,
 * Preview, official, and architecture-specific releases cannot cross-update.
 */
export function configureDesktopUpdateChannel(
  ...
  // Preserve the official distribution's existing architecture feeds.
