      ...
      entries: [
        {
          version: "0.5.2",
          date: "2026-09-23",
          title: "배포 안정성과 Agent 협업 경험 개선",
          changes: [],
          features: [],
          improvements: [
            "서비스 배포 전에 데이터베이스 마이그레이션을 자동 실행하고 실패하면 배포를 중단합니다.",
            "워크스페이스 런타임 모델을 daemon 검색 결과와 병합하고 중복 제거하여 설정한 모델을 항상 선택할 수 있게 했습니다.",
            "Agent 실행 요약, 태스크 활동, 알림을 통한 재개 경험을 개선했습니다.",
          ],
          fixes: [
            "상태 아이콘 열의 스키마 불일치로 태스크 상태 목록 로딩이 실패하는 문제를 수정했습니다.",
            "릴리스 빌드 의존성과 안정 버전 변경 로그 검증 시점을 수정했습니다.",
          ],
        },
        {
          version: "0.4.89",
        ...
        },
        {
          ...
          fixes: [
            ...
            "데스크톱 태스크 환경에서 `multica`와 `missionos` 명령을 모두 제공하여, 시작 직후 CLI를 찾는 데 시간을 쓰지 않도록 했습니다.",
          ],
        },
        {
          version: "0.4.82",
