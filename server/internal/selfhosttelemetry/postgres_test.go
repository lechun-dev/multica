...
func TestTelemetryMigrationsUpAndDown(t *testing.T) {
	...
	up := []string{
		"546_instance_telemetry_state.up.sql",
		"547_instance_telemetry_state_singleton_index.up.sql",
		"548_instance_telemetry_state_primary_key.up.sql",
		"549_agent_task_queue_telemetry_started_index.up.sql",
	}
	for _, name := range up {
	...
	down := []string{
		"549_agent_task_queue_telemetry_started_index.down.sql",
		"548_instance_telemetry_state_primary_key.down.sql",
		"547_instance_telemetry_state_singleton_index.down.sql",
		"546_instance_telemetry_state.down.sql",
	}
