...
func TestIssueTriageStateMigration(t *testing.T) {
	...
	applyMigrationFile(t, ctx, s.pool, "550_issue_triage_state.up.sql")
	...
	applyMigrationFile(t, ctx, s.pool, "556_issue_triage_state_validate.up.sql")
	...
	applyMigrationFile(t, ctx, s.pool, "556_issue_triage_state_validate.down.sql")
	...
	applyMigrationFile(t, ctx, s.pool, "550_issue_triage_state.down.sql")
