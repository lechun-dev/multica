...
func TestTriageStatusKeyReservationIsNotApplied(t *testing.T) {
	...
	for _, file := range []string{
		"542_issue_status_key_not_reserved.up.sql",
		"543_reserve_triage_status_key.up.sql",
		"544_issue_effective_status_triage.up.sql",
		"557_drop_triage_status_key_reservation.up.sql",
	} {
...
func TestDropTriageStatusKeyReservationRepairsAMigratedDatabase(t *testing.T) {
	...
	applyMigrationFile(t, ctx, s.pool, "557_drop_triage_status_key_reservation.up.sql")
	...
	applyMigrationFile(t, ctx, s.pool, "557_drop_triage_status_key_reservation.down.sql")
	if s.reservationExists(t, ctx) {
