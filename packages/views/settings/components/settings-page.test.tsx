...
describe("SettingsPage project permissions switch", () => {
  it("hides project permission tabs and falls back when the server disables them", () => {
    ...
    expect(screen.queryByRole("link", { name: "Project Permissions" })).not.toBeInTheDocument();
    expect(screen.queryByRole("link", { name: "Permission Roles" })).not.toBeInTheDocument();
  ...
  it("shows and mounts project permission tabs only when explicitly enabled", () => {
    ...
    expect(screen.getByRole("link", { name: "Project Permissions" })).toBeInTheDocument();
    expect(screen.getByRole("link", { name: "Permission Roles" })).toBeInTheDocument();
  ...
  it("shows and mounts the organization directory when explicitly enabled", () => {
    ...
    expect(screen.getByRole("link", { name: "Organization Directory" })).toBeInTheDocument();
