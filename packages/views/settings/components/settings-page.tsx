  ...
  const groups = [
    {
      ...
      entries: [
        ...
        entry("issue", t(($) => $.page.tabs.issue), ListTodo, <IssueTab />),
        entry("chat", t(($) => $.page.tabs.chat), MessageCircle, <ChatTab />),
        entry(
          "notifications",
    ...
    },
    {
      ...
      entries: [
        ...
        entry(
          "task-retry-policies",
          t(($) => $.page.tabs.task_retry_policies),
          RotateCcw,
    ...
    },
    {
      ...
      entries: [
        ...
        entry("github", t(($) => $.page.tabs.github), GitHubMark, <GitHubTab />),
        entry(
          "integrations",
        ...
        entry("labs", t(($) => $.page.tabs.labs), FlaskConical, <LabsTab />),
        entry(
          "mcp",
          t(($) => $.page.tabs.mcp),
          Server,
