...
export class ApiClient {
  ...
  async listWorkspaceWakeups(filters: WorkspaceWakeupFilters): Promise<WorkspaceWakeupPage> {
    ...
    const parsed = parseWithFallback<WorkspaceWakeupPage | null>(
      raw,
      WorkspaceWakeupPageSchema,
      null,
      { endpoint: "GET /api/issue-wakeups" },
    );
  ...
  async listIssueWakeups(issueId: string): Promise<IssueWakeup[]> {
    ...
    const parsed = parseWithFallback<IssueWakeup[] | null>(
      raw,
      IssueWakeupSchema.array(),
      null,
      { endpoint: "GET /api/issues/:id/wakeups" },
    );
  ...
  async listIssueWakeupSummaries(): Promise<IssueWakeupSummaryRow[]> {
    ...
    const parsed = parseWithFallback<IssueWakeupSummaryRow[] | null>(
      raw,
      IssueWakeupSummaryRowSchema.array(),
      null,
      { endpoint: "GET /api/issue-wakeup-summaries" },
    );
  ...
  async editIssueWakeupInstruction(
    issueId: string,
    wakeupId: string,
    input: { instruction: string; expected_instruction: string; revision: number },
  ): Promise<void> {
    await this.fetch(
